...
- epochs run: `71`
- selected epoch: `51`
- selected source: `ann/results/canonical/weights_quantized.json`
- selected float shadow: `ann/results/canonical/weights_float_selected.json`
- best float source: `ann/results/canonical/weights_float.json`
