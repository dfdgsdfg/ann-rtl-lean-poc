...
CANONICAL_RESULTS_DIR = ANN_RESULTS_DIR / "canonical"
CANONICAL_MANIFEST_PATH = CANONICAL_RESULTS_DIR / "manifest.json"
CONTRACT_RESULTS_DIR = ROOT / "contract" / "results"
CONTRACT_CANONICAL_DIR = CONTRACT_RESULTS_DIR / "canonical"
CONTRACT_CANONICAL_WEIGHTS_PATH = CONTRACT_CANONICAL_DIR / "weights.json"
