...
- RTL validation: Sparkle elaboration, bounded formal wrapper-equivalence checks for `4/8`, `3/5`, and `1/1`, an invalid-state recovery proof, and directed simulation traces for `4/8` and `3/5`
