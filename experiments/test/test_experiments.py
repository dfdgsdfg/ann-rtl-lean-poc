...
class ExperimentFlowTests(unittest.TestCase):
    ...
    def write_valid_sparkle_verification_manifest(
        ...
        manifest_path: Path,
        *,
        raw_module_name: str = "TinyMLP_sparkleMlpCorePacked",
    ) -> None:
        payload = {
            "schema_version": 2,
            "proof_endpoint": {
                ...
                "decl_name": "TinyMLP.Sparkle.sparkleMlpCorePacked",
            },
            ...
            "exact_emit_path": {
                ...
                "top_module": "TinyMLP.Sparkle.sparkleMlpCorePacked",
                "module_count": 1,
    ...
    def test_matching_sparkle_backend_proof_metadata_passes_status_step(self) -> None:
        with tempfile.TemporaryDirectory(dir=ROOT / "build") as tmpdir:
            ...
            with (
                ...
                patch.object(experiments_run, "check_sparkle_feature_slice", return_value=([], {"Signal.loop": ["rtl-formalize-synthesis/src/TinyMLPSparkle/MlpCoreSignal.lean"]})),
                patch.object(
                    experiments_run,
                    "run_command",
                    return_value=subprocess.CompletedProcess(["lake", "build", "TinyMLPSparkle.BackendSemantics"], 0, "ok", ""),
                ),
            ):
    ...
    def test_sparkle_generated_full_core_proof_sources_include_proof_dependencies(self) -> None:
        ...
        self.assertIn("rtl-formalize-synthesis/src/TinyMLPSparkle/BackendSemantics.lean", source_paths)
