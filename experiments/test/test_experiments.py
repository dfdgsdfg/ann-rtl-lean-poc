...
class ExperimentFlowTests(unittest.TestCase):
    ...
    def test_matching_sparkle_backend_proof_metadata_passes_status_step(self) -> None:
        with build_tempdir() as tmpdir:
            ...
            self.assertEqual(step["details"]["manifest_proof_lane"]["name"], "vanilla")
            self.assertEqual(step["details"]["current_proof_lane"]["arithmetic_provider"], "MlpCore.vanillaArithmeticProofProvider")
    ...
    def test_sparkle_generated_full_core_proof_sources_include_proof_dependencies(self) -> None:
        ...
        self.assertIn("rtl-formalize-synthesis/src/MlpCoreSparkle/ProofConfig.lean", source_paths)
        self.assertIn("rtl-formalize-synthesis/scripts/configure_proof_lane.py", source_paths)
