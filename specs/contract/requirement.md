...
- Generate downstream artifacts: `rtl/results/canonical/sv/weight_rom.sv`, `formalize/src/MlpCore/Defs/SpecCore.lean`, `contract/results/canonical/model.md`, `simulations/shared/test_vectors.mem`
