...
GENERATED_CONTROLLER_DIR := experiments/rtl-formalize-synthsis/sparkle
...
GENERATED_CONTROLLER_TB := simulations/rtl-formalize-synthsis/generated_controller_testbench.sv
